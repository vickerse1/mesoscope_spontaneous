...
rotated_r_ctx = right_isoctx# rotate_3d_matrix(right_isoctx,angle = 22.5)
rotated_l_ctx = left_isoctx# rotate_3d_matrix(left_isoctx,angle = 22.5)
...
for ii in range(len(area_list)):
    ...
    rotate_mask = mask #rotate_3d_matrix(mask,angle = 22.5)
...
if 0:
    svfolder = "C:\\Users\\McCormick Lab\\Documents\\Python\\Hulsey_A1V1M2_CCF_affine_Jan1122\\dan_0_test\\"
    os.mkdir(svfolder)
