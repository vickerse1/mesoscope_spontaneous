function tform = align_recording_to_allen_Vickers_pwl(image,alignareas,affine)
...
saveas(gcf,strcat(outFile,'_CCF_pwl.png'))

%imCCF=imread(strcat(outFile,'_CCF_pwl.png'));
%invtform=invert(tform);
%imCCFinv=imwarp(imCCF,invtform);
%figure;imshow(imCCFinv)
%saveas(gcf,strcat(outFile,'_CCF_pwl_inverse.png'))

save(strcat(outFile,'_pwl'))
end