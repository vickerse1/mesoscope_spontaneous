function tform = align_recording_to_allen_Vickers_alt(image,alignareas,affine)
...
saveas(gcf,strcat(outFile,'_CCF_fit_current.png'))

imCCF=imread(strcat(outFile,'_CCF_fit_current.png'));
invtform=invert(tform);
imCCFinv=imwarp(imCCF,invtform);
figure;imshow(imCCFinv)
saveas(gcf,strcat(outFile,'_CCF_fit_inverse.png'))
