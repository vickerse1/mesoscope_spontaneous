function tform = align_recording_to_allen_Vickers(image,alignareas,affine)
...
saveas(gcf,strcat(outFile,'_CCF_affine_current.png'))

imCCF=imread(strcat(outFile,'_CCF_affine_current.png'));
invtform=invert(tform);
imCCFinv=imwarp(imCCF,invtform);
figure;imshow(imCCFinv)
saveas(gcf,strcat(outFile,'_CCF_affine_inverse.png'))

save(stcat(outFile,'_affine'))
end